//
//  HNConsoleCustomViewController.m
//  Linkesvape
//
...
@interface HNConsoleCustomViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchControllerDelegate,UISearchResultsUpdating>
{
    NSInteger _page;
}
...
@implementation HNConsoleCustomViewController
...
- (void)setNavgationStyle{
    ...
    [self setNavigationTitle:NSLocalizedString(@"自定义模式", nil)];
    ...
    UIBarButtonItem *itemSearch = [[UIBarButtonItem alloc]initWithCustomView:searchButton];
    [searchButton addTarget:self action:@selector(onRightButtonClick:) forControlEvents:UIControlEventTouchUpInside];
    
    [self.navigationItem setRightBarButtonItems:@[itemSearch,itemAdd]];
...
- (void)addAction:(id)sender{
    HNConsoleAddModelViewController * vc = [HNConsoleAddModelViewController new];
...
- (void)updateSearchResultsForSearchController:(UISearchController *)searchController{
    ...
    NSDictionary *dic = @{@"type":@"custom",@"search":searchString};
