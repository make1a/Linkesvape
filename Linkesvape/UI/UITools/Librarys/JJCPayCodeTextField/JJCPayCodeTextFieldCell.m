...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.contentView.backgroundColor = CurrentThemeIsWhite ? [UIColor clearColor] : [UIColor whiteColor];
    }
    return self;
}
...
- (void)setCellType:(JJCPayCodeTextFieldCellType)cellType {
    ...
    if (cellType == JJCPayCodeTextFieldCellTypeEveryBorder) {
        ...
        self.contentView.layer.cornerRadius = Handle(5);
...
- (void)setCellBorderColor:(UIColor *)cellBorderColor {
    ...
    if (cellBorderColor) {
        if (self.cellType == JJCPayCodeTextFieldCellTypeEveryBorder) {
            ...
            self.contentView.layer.cornerRadius = Handle(2);
